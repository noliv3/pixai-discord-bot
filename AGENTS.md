...
- 🛰️ Phase-2 Scanner: Kernlogik liegt jetzt unter `bot/events/messageCreate_v1.js`, `bot/events/messageReactionAdd_v1.js`, `bot/events/messageReactionRemove_v1.js` und den neuen Bibliotheken `bot/lib/scanCore_v1.js`, `urlSanitizer_v1.js`, `tagUtils_v1.js`, `riskEngine_v1.js`, `scanCache_v1.js`, `modReview_v1.js`, `eventUpload_v1.js`, `voteUtils_v1.js`. Nur `scannerClient_v1.js` spricht HTTP mit dem Scanner.
